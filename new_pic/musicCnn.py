...
xs = tf.placeholder(tf.float32, [None, 160*160*3]) # 28x28
...
h_pool2_flat = tf.reshape(h_pool2, [-1, 40*40*16])
...
sess = tf.Session(config=tf.ConfigProto(log_device_placement=False))# important step
